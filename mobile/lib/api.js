...
export async function fetchMatchup() {
  ...
  // 3. get opponent's team name and both teams' projected totals in parallel
  ...
  return {
    week: WEEK,
    my_team: { name: myTeam.team_name, points: myMatchup.points, projected_points: myProj.projected_points ?? 0 },
    opponent: { name: oppTeam.team_name, points: oppMatchup.points, projected_points: oppProj.projected_points ?? 0 },
  };
}
